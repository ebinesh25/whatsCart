...
export default function BuyerStorePage() {
  ...
  const loadStoreData = async () => {
    try {
      ...
      const foundBusiness = businesses.find((b) => b.slug === slug && b.isActive)
      ...
      const businessProducts = allProducts.filter(
        (p) => p.businessId === foundBusiness.id && p.isActive
      )
            ...
            {products.map((product) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <p className="text-lg font-bold" style={{ color: business.color }}>
                    ₹{product.price}
                  </p>
                  ...
                  <button
                    ...
                    className="w-full mt-3 py-2 rounded-lg font-medium transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed"
                    style={{
